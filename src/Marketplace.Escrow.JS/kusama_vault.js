...
async function addIncomingKusamaTransaction(amount, address, blockNumber) {
  ...
  await conn.query(`INSERT INTO public."${incomingTxTable}"("Id", "Amount", "Description", "AccountPublicKey", "BlockId", "Status", "LockTime", "ErrorMessage") VALUES ($1, $2, \'\', $3, $4, 0, null, null);`, 
