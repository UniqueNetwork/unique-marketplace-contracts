...
*/
    ...
    */
    ...
    uptloc: { 
      /* starts local copy of Unique Public testnet,  deploy  works ok and fast. Test needs more testing 
       to run every test:
       rm -r../ganache_UPT 
       ganache-cli -i 8888 -p 8545  --db ../ganache_UPT -f https://rpc-opal.unique.network/
       !!! check in .env UPGRADE_FLAG = 0
       and, in second terminal window:
      truffle test --reset --network uptloc      
       */
            provider: () => new HDWalletProvider({
                privateKeys: [pkOnwer,pkEscrow, pktestbuyer, pktestseller],  
